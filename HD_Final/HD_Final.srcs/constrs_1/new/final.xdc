...
# pmodA1, pmodA2, pmodA4;
#Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {pmodA1}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmodA1}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {pmodA2}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmodA2}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {JA[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JA[2]}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {pmodA4}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmodA4}]
##Sch name = JA7
...
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_5}]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {pmod_6}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_6}]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {pmod_7}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_7}]
#Sch name = JB10
...
set_property IOSTANDARD LVCMOS33 [get_ports {sen_1}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {sen_2}]
set_property IOSTANDARD LVCMOS33 [get_ports {sen_2}]
##Sch name = JC3
